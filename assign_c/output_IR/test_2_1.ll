...
entry:
  ...
  %call = call i8* @strcpy(i8* noundef %arraydecay, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #5, !dbg !15
  ...
  %arraydecay6 = getelementptr inbounds [10 x i8], [10 x i8]* %buffer, i64 0, i64 0, !dbg !25
  %call7 = call i8* @strncpy(i8* noundef %arraydecay5, i8* noundef %arraydecay6, i64 noundef 10) #5, !dbg !26
...
for.end:                                          ; preds = %for.cond
  ...
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !dbg !48
  %call19 = call i8* @fgets(i8* noundef %arraydecay18, i32 noundef 10, %struct._IO_FILE* noundef %9), !dbg !49
  %tobool = icmp ne i8* %call19, null, !dbg !49
  br i1 %tobool, label %if.then, label %if.end, !dbg !49

if.then:                                          ; preds = %for.end
  %arraydecay20 = getelementptr inbounds [10 x i8], [10 x i8]* %buffer, i64 0, i64 0, !dbg !50
  %call21 = call i64 @strcspn(i8* noundef %arraydecay20, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0)) #6, !dbg !51
  %arrayidx22 = getelementptr inbounds [10 x i8], [10 x i8]* %buffer, i64 0, i64 %call21, !dbg !52
  store i8 0, i8* %arrayidx22, align 1, !dbg !53
  br label %if.end, !dbg !54

if.end:                                           ; preds = %if.then, %for.end
  %arraydecay23 = getelementptr inbounds [10 x i8], [10 x i8]* %buffer, i64 0, i64 0, !dbg !55
  %call24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* noundef %arraydecay23), !dbg !56
  ret void, !dbg !57
}
...
!1 = !DIFile(filename: "assign_c/test_2_1.c", directory: "/home/rohith/Desktop/8SemMat/ipaco/llvm-project/project", checksumkind: CSK_MD5, checksum: "197993f1ab5e8f275b3d9fa3ce0ca392")
...
!9 = !DIFile(filename: "./assign_c//test_2_1.c", directory: "/home/rohith/Desktop/8SemMat/ipaco/llvm-project/project", checksumkind: CSK_MD5, checksum: "197993f1ab5e8f275b3d9fa3ce0ca392")
...
!47 = !DILocation(line: 36, column: 15, scope: !8)
!48 = !DILocation(line: 36, column: 39, scope: !8)
!49 = !DILocation(line: 36, column: 9, scope: !8)
!50 = !DILocation(line: 37, column: 24, scope: !8)
!51 = !DILocation(line: 37, column: 16, scope: !8)
!52 = !DILocation(line: 37, column: 9, scope: !8)
!53 = !DILocation(line: 37, column: 39, scope: !8)
!54 = !DILocation(line: 38, column: 5, scope: !8)
!55 = !DILocation(line: 40, column: 33, scope: !8)
!56 = !DILocation(line: 40, column: 5, scope: !8)
!57 = !DILocation(line: 41, column: 1, scope: !8)
!58 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 43, type: !10, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !11)
!59 = !DILocation(line: 44, column: 5, scope: !58)
!60 = !DILocation(line: 45, column: 5, scope: !58)
