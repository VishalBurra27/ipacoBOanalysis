...
entry:
  ...
  %call = call i8* @strcpy(i8* noundef %arraydecay, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #4
  ...
  %call7 = call i8* @strncpy(i8* noundef %arraydecay5, i8* noundef %arraydecay6, i64 noundef 10) #4
...
for.end:                                          ; preds = %for.cond
  ...
  %call19 = call i32 (i8*, ...) bitcast (i32 (...)* @gets to i32 (i8*, ...)*)(i8* noundef %arraydecay18)
  %arraydecay20 = getelementptr inbounds [10 x i8], [10 x i8]* %buffer, i64 0, i64 0
  %call21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i8* noundef %arraydecay20)
  ret void
}
